...
class SCPieSliceTests: XCTestCase {
    func testBasics() throws {
        ...
        XCTAssertEqual(slice1.radius, 224)
        XCTAssertEqual(slice1.labelPosition(from: middle).x, 350.3, accuracy: 0.05)
        XCTAssertEqual(slice1.labelPosition(from: middle).y, 129.69, accuracy: 0.05)
        XCTAssertEqual(slice1.title, "aSlice")
        XCTAssertEqual(slice1.color, .blue)
        XCTAssertEqual(slice1.value, 50.0)
        XCTAssertEqual(slice1.idString, "aSlice50.0blue224.08.00.7853981633974483")
        ...
        XCTAssertEqual(slice2.radius, 244)
        XCTAssertEqual(slice2.labelPosition(from: middle).x, 175.6, accuracy: 0.05)
        XCTAssertEqual(slice2.labelPosition(from: middle).y, 130.91, accuracy: 0.05)
        XCTAssertEqual(slice2.idString, "aSlice50.0blue244.018.02.181661564992912")
